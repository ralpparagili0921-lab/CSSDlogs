...
var CACHE_NAME = 'cssd-shell-v2026.09.23.wide-table-overflow-fix';
var SHELL_URLS = [
  './', './index.html', './css/style.css',
  './js/config.js', './js/offline-queue.js', './js/db.js', './js/true-time.js', './js/search-bar.js', './js/dtr-import.js', './js/form-draft.js', './js/error-reporter.js', './js/alarm.js', './js/print-report.js', './js/history-view.js', './js/scheduled-alarms.js', './js/missed-entries-view.js', './js/late-entry-reason.js', './js/identity-confirm.js', './js/ui.js',
  './js/work-calendar.js', './js/missed-logs.js', './js/auth.js',
  './js/public-dashboard.js',
  './js/handover-submit-portal.js',
  './js/ro.js', './js/equipment.js', './js/cycle-log.js',
  './js/qa-testing.js', './js/instrument-maintenance.js', './js/brush.js',
  './js/temp-humidity.js', './js/housekeeping.js', './js/handover.js',
  './js/reports.js', './js/admin.js', './js/error-reports-view.js', './js/main.js',
