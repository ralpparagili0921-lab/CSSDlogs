...
var CACHE_NAME = 'cssd-shell-v2026.08.19.09';
var SHELL_URLS = [
  './', './index.html', './css/style.css',
  './js/config.js', './js/offline-queue.js', './js/db.js', './js/true-time.js', './js/search-bar.js', './js/dtr-import.js', './js/form-draft.js', './js/error-reporter.js', './js/alarm.js', './js/print-report.js', './js/history-view.js', './js/ui.js',
