...
var CACHE_NAME = 'cssd-shell-v2026.08.14.08';
var SHELL_URLS = [
  './', './index.html', './css/style.css',
  './js/config.js', './js/offline-queue.js', './js/db.js', './js/search-bar.js', './js/dtr-import.js', './js/form-draft.js', './js/error-reporter.js', './js/ui.js',
