...
const MOBILE_LOGBOOK_ITEMS = [
  { view: 'equipment', label: 'Equipment', badge: 'nav-badge-equipment', icon: '<circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 3"/>' },
  { view: 'qa', label: 'QA Testing', badge: 'nav-badge-qa', icon: '<path d="M9 11l3 3 8-8"/><path d="M21 12v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h11"/>' },
  { view: 'cycles', label: 'Cycle Log', badge: 'nav-badge-cycles', icon: '<path d="M4 12a8 8 0 1 1 3 6.3"/><path d="M4 20v-5h5"/>' },
  { view: 'instruments', label: 'Instruments', icon: '<path d="M14.5 3.5a2.1 2.1 0 0 1 3 3L8 16l-4 1 1-4Z"/>' },
  { view: 'ro', label: 'RO Water', icon: '<path d="M12 2c3 4 6 7.5 6 11.5A6 6 0 1 1 6 13.5C6 9.5 9 6 12 2Z"/>' },
  { view: 'brush', label: 'Brush', icon: '<path d="M4 20l7-7"/><path d="M13 13l6.5-6.5a2.1 2.1 0 0 0-3-3L10 10"/><path d="M4 20l3-1 1-3"/>' },
  { view: 'temp-humidity', label: 'Temp/Humidity', icon: '<path d="M12 2a3 3 0 0 0-3 3v9.5a5 5 0 1 0 6 0V5a3 3 0 0 0-3-3Z"/><circle cx="12" cy="17" r="2"/>' },
  { view: 'housekeeping', label: 'Housekeeping', icon: '<path d="M3 3l18 18"/><path d="M10 4 4 10c-1 4 2 10 6 10s7-6 6-10l-2-2"/>' },
  { view: 'handover', label: 'Handover', badge: 'nav-badge-handover', icon: '<path d="M16 3l4 4-4 4"/><path d="M20 7H8a4 4 0 0 0-4 4v1"/><path d="M8 21l-4-4 4-4"/><path d="M4 17h12a4 4 0 0 0 4-4v-1"/>' }
];
const MOBILE_ADMIN_EXTRA_ITEMS = [
  { view: 'dashboard', label: 'Dashboard', icon: '<rect x="3" y="3" width="7" height="9" rx="1.5"/><rect x="14" y="3" width="7" height="5" rx="1.5"/><rect x="14" y="12" width="7" height="9" rx="1.5"/><rect x="3" y="16" width="7" height="5" rx="1.5"/>' },
  { view: 'reports', label: 'KPI Reports', icon: '<path d="M4 19V5a1 1 0 0 1 1-1h9l6 6v9a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1Z"/><path d="M14 4v6h6"/>' }
];
...
const App = {
  ...
  _syncMobileBadges() {
    ...
    Object.keys(this._mobileCounts).forEach(view => {
      ...
      if (btDot) { btDot.textContent = count > 99 ? '99+' : count; btDot.classList.toggle('hidden', count === 0); }
    });
  },
