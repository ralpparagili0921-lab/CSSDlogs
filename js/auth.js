...
const Auth = {
  ...
  async renderLogin() {
    ...
    card.innerHTML = `
      ...
      <button id="btn-handover-portal" style="width:100%;margin:18px 0 18px;padding:20px 18px;border:none;border-radius:var(--radius);background:var(--brand);color:#fff;font-weight:800;font-size:16px;cursor:pointer;box-shadow:var(--shadow);">📦 Instrument/Supplies Handover<div style="font-weight:500;font-size:12.5px;opacity:.85;margin-top:4px;">For ER, OPD, OR, and Ward staff — submitting and releasing</div></button>
    ...
    document.getElementById('btn-handover-portal').addEventListener('click', () => DepartmentPortal.show());
