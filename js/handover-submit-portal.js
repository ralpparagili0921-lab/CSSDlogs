...
const DepartmentPortal = {
  ...
  _renderPinEntry(account) {
    ...
    card.innerHTML = `
      ...
      <div class="pin-dots" id="dp-pin-dots"><span class="pin-dot"></span><span class="pin-dot"></span><span class="pin-dot"></span><span class="pin-dot"></span></div>
  ...
  _openVerifyModal(row) {
    ...
    const modal = UI.showModal(`
      ...
      <div class="field" style="margin-bottom:14px;">
        ...
        <div class="pin-dots" id="dp-verify-dots"><span class="pin-dot"></span><span class="pin-dot"></span><span class="pin-dot"></span><span class="pin-dot"></span></div>
