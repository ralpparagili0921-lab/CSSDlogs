...
const HandoverView = {
  async render() {
    ...
    el.innerHTML = `
      ...
      <div class="table-wrap"><table>
        <thead><tr><th>Department</th><th>Submitted by</th><th>Load contents</th><th>Status</th><th>Received</th><th>Released</th><th>Verified</th></tr></thead>
  ...
  async _loadTable() {
    ...
    try {
      ...
      if (rows.length === 0) {
        tbody.innerHTML = `<tr><td colspan="7" class="empty-state">No handovers logged yet.</td></tr>`;
        return;
      }
