    ...
    el.innerHTML = `
      ...
      <div class="card card-pad" style="display:flex;align-items:center;justify-content:space-between;gap:14px;flex-wrap:wrap;">
        <div>
          ...
          <div class="hint" style="margin-top:4px;max-width:480px;">Acknowledging an alarm silences it for this long — if the cycle/BI result is still unresolved once that time passes, it sounds again. Applies app-wide, for everyone.</div>
        </div>
